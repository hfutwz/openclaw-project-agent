...
本文以《软件过程管理》课程 Lab 项目——自习座位预约系统（SeatFlow）——为具体载体，尝试回答上述问题。SeatFlow 是一个涵盖学生预约、签到、RBAC 权限管理的 Web 全栈系统，由5名组员在 AI 辅助下协作开发，历时约一个月。本文不是泛泛而谈 AI 如何"提效"，而是从真实的提交记录、实测 Bug、团队冲突和流程决策出发，探讨 AI 时代软件过程管理的具体实践路径。
